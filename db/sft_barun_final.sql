...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2016 at 04:41 PM
...
INSERT INTO `sft_wellness` (`id`, `wellness_name`, `type`, `partner_id`, `program_id`, `country_id`, `no_of_day`, `price`, `pdf`, `code`) VALUES
(1, 'test', 1, 1, 0, 0, 6, 56000, '', '1TN8FXC3'),
(2, 'abcd', 1, 1, 0, 0, 19, 4566, '', 'DW2HOACV');
