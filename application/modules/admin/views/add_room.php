        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <h2>Add Room </h2><div class="text-right"><a href="<?php echo base_url('admin/master/list_partner'); ?>" class="btn btn-warning">Back </a></div>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="room_type" name="room_type"  class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="room_name" name="room_name"  class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
