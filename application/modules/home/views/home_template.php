        ...
        <ul class="nav sidebar-nav navbar-nav">
          ...
          <li class="dropdown"> <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Wellness </a>
            <ul class="dropdown-menu" role="menu">
              ...
              <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Wellness Concepts</a>
                <ul class="dropdown-menu">
                  <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Wellness Plus</a>
                    <ul class="dropdown-menu">
                      <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Best of Bests</a>
                        <ul class="dropdown-menu">
                          <li><a href="javascript:void(0)">Best in Africa</a></li>
                          <li><a href="javascript:void(0)">Best in Asia</a></li>
                          <li><a href="javascript:void(0)">Best in Australia, New Zealand &amp; Oceania</a></li>
                          <li><a href="javascript:void(0)">Best in Europe</a></li>
                          <li><a href="javascript:void(0)">Best in North America</a></li>
                          <li><a href="javascript:void(0)">Best in South &amp; Central America</a></li>
                        </ul>
                      </li>
                      <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Best in Region</a>
                        <ul class="dropdown-menu">
                          <li><a href="javascript:void(0)">Best in the Caribbean</a></li>
                          <li><a href="javascript:void(0)">Best in Central America</a></li>
                          <li><a href="javascript:void(0)">Best in Eastern Europe</a></li>
                          <li><a href="javascript:void(0)">Best in the Middle East</a></li>
                          <li><a href="javascript:void(0)">Best in the Nordic Countries</a></li>
                        </ul>
                      </li>
                      <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Best of Programs</a>
                        <ul class="dropdown-menu">
                          <li><a href="javascript:void(0)">Best for Affordability/Budget</a></li>
                          <li><a href="javascript:void(0)">Best Ahead-of-the-Curve Innovation</a></li>
                          <li><a href="javascript:void(0)">Best for Beauty &amp; Anti-Aging</a></li>
                          <li><a href="javascript:void(0)">Best for Couples</a></li>
                          <li><a href="javascript:void(0)">Best Eco-friendly &amp; Sustainable Property</a></li>
                          <li><a href="javascript:void(0)">Best for Families</a></li>
                          <li><a href="javascript:void(0)">Best for Fitness</a></li>
                          <li><a href="javascript:void(0)">Best for Girlfriend Getaways</a></li>
                          <li><a href="javascript:void(0)">Best for Going Solo</a></li>
                          <li><a href="javascript:void(0)">Best Hidden Gem</a></li>
                          <li><a href="javascript:void(0)">Best for Hot Springs</a></li>
                          <li><a href="javascript:void(0)">Best for Medical Services</a></li>
                          <li><a href="javascript:void(0)">Best for Men</a></li>
                          <li><a href="javascript:void(0)">Best for Mind &amp; Spirit</a></li>
                          <li><a href="javascript:void(0)">Best New Spa &amp; Wellness Property</a></li>
                          <li><a href="javascript:void(0)">Best for Nutrition &amp; Healthy Cuisine</a></li>
                          <li><a href="javascript:void(0)">Best for Outdoor Adventure &amp; Activities</a></li>
                          <li><a href="javascript:void(0)">Best Weight Loss Program</a></li>
                          <li><a href="javascript:void(0)">Best for the "Wow" Factor</a></li>
                          <li><a href="javascript:void(0)">Best for Yoga</a></li>
                        </ul>
                      </li>
                    </ul>
                  </li>
                  <li><a href="javascript:void(0)"> Medi Plus</a></li>
                  <li><a href="javascript:void(0)"> Beauty Plus</a></li>
                </ul>
              </li>
      ...
      <div class="container">
        ...
        <ul class="nav sidebar-nav navbar-nav" data-hover="dropdown" data-animations="fadeInLeft fadeInRight fadeInRight fadeInRight">
          ...
          <li class="dropdown"> <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Wellness </a>
            <ul class="dropdown-menu" role="menu">
              <li class="dummy-list">&nbsp;</li>
              <li class="dropdown"><a href="javascript:void(0)">Wellness Concepts</a>
                <ul class="dropdown-menu dropdownhover-left">
                  <li class="dropdown"><a href="javascript:void(0)">Wellness Plus</a>
                    <ul class="dropdown-menu dropdownhover-left">
                      <li class="dropdown"><a href="javascript:void(0)">Best of Bests</a>
                        <ul class="dropdown-menu dropdownhover-left">
                          <li><a href="javascript:void(0)">Best in Africa</a></li>
                          <li><a href="javascript:void(0)">Best in Asia</a></li>
                          <li><a href="javascript:void(0)">Best in Australia, New Zealand &amp; Oceania</a></li>
                      ...
                      <li class="dropdown"><a href="javascript:void(0)">Best in Region</a>
                        <ul class="dropdown-menu dropdownhover-left">
                          <li><a href="javascript:void(0)">Best in the Caribbean</a></li>
                          <li><a href="javascript:void(0)">Best in Central America</a></li>
                          <li><a href="javascript:void(0)">Best in Eastern Europe</a></li>
                      ...
                      <li class="dropdown"><a href="javascript:void(0)">Best of Programs</a>
                        <ul class="dropdown-menu dropdownhover-left">
                          <li><a href="javascript:void(0)">Best for Affordability/Budget</a></li>
                          <li><a href="javascript:void(0)">Best Ahead-of-the-Curve Innovation</a></li>
                          <li><a href="javascript:void(0)">Best for Beauty &amp; Anti-Aging</a></li>
