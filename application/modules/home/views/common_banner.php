  ...
  <div class="tp-banner" >
    <ul>
      ...
      <li data-transition="zoomout" data-slotamount="5" data-masterspeed="700"  data-saveperformance="off" > 
        <!-- MAIN IMAGE --> 
        <img src="<?php echo base_url(); ?>front/images/wellness-concepts/slider/slider03.jpg"  alt="SFT - Wellness"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
        <!-- LAYERS --> 
        <!-- LAYER NR. 1 -->
      ...
      <li data-transition="zoomout" data-slotamount="5" data-masterspeed="700"  data-saveperformance="off" > 
        ...
        <!-- MAIN IMAGE --> 
        <img src="<?php echo base_url(); ?>front/images/wellness-concepts/slider/slider04.jpg"  alt="SFT - Wellness"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
        <!-- LAYERS --> 
        <!-- LAYER NR. 1 -->
        <div class="tp-caption pp_subheader sfl stl tp-resizeme" 
              data-x="center" data-hoffset="0" 
